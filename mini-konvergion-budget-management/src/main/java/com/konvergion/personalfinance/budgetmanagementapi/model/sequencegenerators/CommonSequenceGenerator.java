package com.konvergion.personalfinance.budgetmanagementapi.model.sequencegenerators;
...
public class CommonSequenceGenerator extends SequenceStyleGenerator {
	/*
